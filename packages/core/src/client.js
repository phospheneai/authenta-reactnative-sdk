...
class AuthentaClient {
     ...
     *   });
     */
    async uploadAndPoll(uri, modelType, { autoPolling = true, interval, timeout, isSingleFace = true, faceswapCheck = false, livenessCheck = false, faceSimilarityCheck = false, referenceImage, } = {}) {
        var _a;
